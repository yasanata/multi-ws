...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/yasanata/update/main/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/yasanata/update/main/version_up)
...
serverV=$( curl -sS https://raw.githubusercontent.com/yasanata/update/main/version_up)
if [ "$Isadmin" = "ON" ]; then
...
echo -e "                     List Menu                  "
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "  ${COLOR1}[01]${NC} • [${YELLOW}Menu${NC}] SSHWS     ${COLOR1}[07]${NC} • [${YELLOW}Menu${NC}] BACKUP    $COLOR1│$NC"
echo -e "  ${COLOR1}[02]${NC} • [${YELLOW}Menu${NC}] VMESS     ${COLOR1}[08]${NC} • [${YELLOW}Menu${NC}] THEME     $COLOR1│$NC"
